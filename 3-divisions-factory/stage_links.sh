...
tfvars_file="${base_dir}/tfvars/divisions-factory/${first_char}-${division}.auto.tfvars"  # tfvars file
global_tfvars_file="${base_dir}/tfvars/0-globals.auto.tfvars"                             # global tfvars file
provider_file="${base_dir}/providers/divisions-factory/${first_char}-${division}-provider.tf"  # provider file
